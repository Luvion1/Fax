...
pub static KEYWORDS: LazyLock<HashMap<&'static str, TokenType>> = LazyLock::new(|| {
    ...
    let keys = [
        "fn", "let", "mut", "const", "module", "use", "pub", "priv", "internal",
        "struct", "enum", "trait", "impl", "type", "alias", "class", "interface",
        "extern", "as", "where", "if", "else", "while", "for", "loop", 
        "return", "break", "continue", "in", "extends",
        "implements", "super", "this", "new", "delete", "async", "await",
        "try", "catch", "finally", "throw", "spawn", "yield", "move", "ref",
        "unsafe", "dyn", "static", "self", "Self", "crate", "i8", "i16", "i32",
        "i64", "u8", "u16", "u32", "u64", "f32", "f64", "bool", "int", "str", "char", "void", "any",
    ];
    for k in keys {
