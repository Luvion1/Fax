...
pub const TokenType = enum {
    ...
    pub fn from(s: []const u8) TokenType {
        const map = .{ .{ "Identifier", .Identifier }, .{ "String", .String }, .{ "Number", .Number }, .{ "Boolean", .Boolean }, .{ "Null", .Null }, .{ "Keyword", .Keyword }, .{ "Operator", .Operator }, .{ "Symbol", .Symbol }, .{ "ScopeResolution", .ScopeResolution }, .{ "ReturnType", .ReturnType }, .{ "LeftParen", .LeftParen }, .{ "RightParen", .RightParen }, .{ "LeftBrace", .LeftBrace }, .{ "RightBrace", .RightBrace }, .{ "LeftBracket", .LeftBracket }, .{ "RightBracket", .RightBracket }, .{ "Comma", .Comma }, .{ "Semicolon", .Semicolon }, .{ "Colon", .Colon }, .{ "Dot", .Dot }, .{ "EOF", .EOF } };
