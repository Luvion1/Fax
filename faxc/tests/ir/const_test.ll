...
entry:
    ...
    store i64 3, i64* %PI_0_ptr
    store i64 10, i64* %r_1_ptr
    %tmp3 = load i64, i64* %PI_0_ptr
    %tmp4 = load i64, i64* %r_1_ptr
    %bin5 = mul i64 %tmp3, %tmp4
    %tmp6 = load i64, i64* %r_1_ptr
    %bin7 = mul i64 %bin5, %tmp6
    store i64 %bin7, i64* %area_2_ptr
    %tmp8 = load i64, i64* %area_2_ptr
