...
entry:
    ...
    %ptr1 = getelementptr inbounds [10 x i8], [10 x i8]* @str0, i32 0, i32 0
    %cast_i642 = ptrtoint i8* %ptr1 to i64
    %str_cast3 = inttoptr i64 %cast_i642 to i8*
    store i8* %str_cast3, i8** %message_0_ptr
    %ptr_raw4 = load i8*, i8** %message_0_ptr
    %ign5 = call i64 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %ptr_raw4)
    call void @fax_gc_pop_frame()
    ret i64 0
}
@str0 = private unnamed_addr constant [10 x i8] c"Hello Fax\00"