...
entry:
    ...
    %ptr0 = getelementptr inbounds [17 x i8], [17 x i8]* @str0, i32 0, i32 0
    ...
    %str_ptr3 = inttoptr i64 %ptr_i642 to i8*
    call i64 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %str_ptr3)
    %ptr4 = getelementptr inbounds [18 x i8], [18 x i8]* @str1, i32 0, i32 0
    %res4 = ptrtoint i8* %ptr4 to i64
    %s2_ptr = alloca i8*
    %str_cast5 = inttoptr i64 %res4 to i8*
    store i8* %str_cast5, i8** %s2_ptr
    %ptr_raw6 = load i8*, i8** %s2_ptr
    %ptr_i646 = ptrtoint i8* %ptr_raw6 to i64
    %str_ptr7 = inttoptr i64 %ptr_i646 to i8*
    call i64 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %str_ptr7)
    call void @fax_gc_pop_frame()
    ret i64 0
}
@str0 = private unnamed_addr constant [17 x i8] c"Hello, Fax-lang!\00"
@str1 = private unnamed_addr constant [18 x i8] c"Multi\0Aline\0Astring\00"