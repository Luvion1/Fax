...
entry:
    ...
    store i64 10, i64* %x_0_ptr
    %cond_bit2 = icmp ne i64 0, 0
    br i1 %cond_bit2, label %then2, label %end2

then2:
        store i64 20, i64* %x_1_ptr
        br label %end2

end2:
    %tmp3 = load i64, i64* %x_0_ptr
    call i64 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmt_int, i32 0, i32 0), i64 %tmp3)
