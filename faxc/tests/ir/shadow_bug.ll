...
entry:
    ...
    store i64 10, i64* %a_0_ptr
    %tmp2 = load i64, i64* %a_0_ptr
    %cmp3 = icmp eq i64 %tmp2, 10
    %zext3 = zext i1 %cmp3 to i64
    %cond_bit4 = icmp ne i64 %zext3, 0
    br i1 %cond_bit4, label %then4, label %end4

then4:
        store i64 20, i64* %a_1_ptr
        %tmp5 = load i64, i64* %a_1_ptr
        call i64 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmt_int, i32 0, i32 0), i64 %tmp5)
        br label %end4

end4:
    %tmp6 = load i64, i64* %a_0_ptr
