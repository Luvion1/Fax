...
"language/pattern-matching.md": {
	id: "language/pattern-matching.md";
...
"language/structs.md": {
	id: "language/structs.md";
  slug: "language/structs";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"language/types.md": {
	id: "language/types.md";
  slug: "language/types";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
